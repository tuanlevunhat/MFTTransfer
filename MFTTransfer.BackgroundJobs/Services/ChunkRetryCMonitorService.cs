...
{
    public class ChunkRetryCMonitorService : BackgroundService
    {
        private readonly ChunkProcessingHelper _chunkHelper;
        private readonly ILogger<ChunkRetryCMonitorService> _logger;
        ...
        public ChunkRetryCMonitorService(
            ILogger<ChunkRetryCMonitorService> logger,
