...
using Nito.AsyncEx;
using static MFTTransfer.Infrastructure.CacheKey;
...
namespace MFTTransfer.Infrastructure
{
    ...
    public abstract class DistributedCacheManager : CacheKeyService, ILocker, IStaticCacheManager
    {
        ...
        protected DistributedCacheManager(IConfiguration configuration, IDistributedCache distributedCache) : base(configuration)
        {
